...
namespace Adventure.GameEngine.Persistence
{
    ...
    {
        public static Dictionary<TKey, TValue> Dic<TKey, TValue>(BinaryReader reader,
        ...
        public static void WriteDic<TValue>(IDictionary<string, TValue> dic, BinaryWriter writer, Action<BinaryWriter, string> writeValue)
        {
            writer.Write(dic.Count);
            foreach (var (key, value) in dic)
            {
