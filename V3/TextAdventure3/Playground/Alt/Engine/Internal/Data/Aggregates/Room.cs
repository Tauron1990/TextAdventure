...
namespace TextAdventures.Engine.Internal.Data.Aggregates
{
                                    ...
                                    IApply<RoomCommandsAddedEvent>, IApply<RoomDescriptionChangedEvent>
    {
        ...
        public List<CommandLayer> Layers { get; set; } = new();

        public Stack<Description> Descriptions { get; } = new();

        public Stack<Description> DetailDescriptions { get; } = new();
                               ...
                               IExecute<AddCommandLayerCommand>
    {
        ...
        public bool Execute(CreateRoomCommand command)
        {
            ...
            {
                EmitAll(new RoomCreatedEvent(command.RoomName, command.AggregateId, command.Doorways),
