...
namespace TextAdventures.Engine.Internal.Data.Commands
{
    ...
    {
        protected GameActorCommand(GameActorId aggregateId) : base(aggregateId)
        {
        }

        protected GameActorCommand(GameActorId aggregateId, [NotNull] CommandId sourceId) : base(aggregateId, sourceId)
        {
        }
    }
}