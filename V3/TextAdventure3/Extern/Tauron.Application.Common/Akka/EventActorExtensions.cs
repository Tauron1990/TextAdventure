...
namespace Tauron.Akka
{
    ...
    public static class EventActorExtensions
    {
        ...
        public static IEventActor CreateEventActor<TPayload>(this IActorRefFactory system, Action<TPayload> handler,
            bool killOnFirstResponse = false) => EventActor.Create(system, handler, killOnFirstResponse);

        public static IEventActor CreateEventActor(this IActorRefFactory system, string? name,
            bool killOnFirstResponse = false) => EventActor.Create(system, name, killOnFirstResponse);
