...
namespace Tauron.Localization.Extension
{
    ...
    public sealed class LocExtensionAdaptor
    {
        ...
        public object? Request(string name, CultureInfo? info = null) => _extension.LocCoordinator.Ask<LocCoordinator.ResponseLocValue>(new LocCoordinator.RequestLocValue(name, info ?? CultureInfo.CurrentUICulture)).Result.Result;
        ...
        public string RequestString(string name, CultureInfo? info = null) => Request(name, info)?.ToString() ?? string.Empty;
