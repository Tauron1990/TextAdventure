...
namespace Tauron
{
        ...
        : AbastractTargetSelectorForward<AyncReceiveBuilder<TRecieve, TNext, TStart, TParent>, TStart, TParent, AsyncFuncTargetSelector<TRecieve, TNext, TStart, TParent>>
    {
        ...
        public override AyncReceiveBuilder<TRecieve, TNext, TStart, TParent> ToRef(Func<IActorContext, IActorRef> actorRef) => new(Flow, actorRef, _transformer, ShouldForward);
    }
    ...
    public sealed class ActionFinisher<TRecieve, TStart, TParent>
    {
        ...
        public RunSelector<TNew, TStart, TParent> AndRespondTo<TNew>() => new(_flow);
        ...
        public TParent AndReturn() => _flow.Return();
    ...
    public abstract class ReceiveBuilderBase<TNext, TStart, TParent>
    {
        ...
        public RunSelector<TNext, TStart, TParent> Then => new(Flow);

        public RunSelector<TReposnd, TStart, TParent> AndRespondTo<TReposnd>() => new(Flow);
    }
    ...
    public sealed class ActorFlowBuilder<TStart, TParent>
    {
        ...
        public RunSelector<TStart, TStart, TParent> From => new(this);
        ...
        private sealed class EntryPoint
        {
            ...
            public EntryPoint(IActorRef actor) => _actor = actor;
